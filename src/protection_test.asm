...
main(int argc, char *argv[])
{
    ...
    100e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
    1011:	83 ec 2c             	sub    $0x2c,%esp
    int a[5] = {1,2,3,4,5};
    1014:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    101b:	c7 45 e8 02 00 00 00 	movl   $0x2,-0x18(%ebp)
    int x = (int)a-((int)a&(PGSIZE-1));
    1022:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    mprotect((void *)x, 1);
    1027:	6a 01                	push   $0x1
    int a[5] = {1,2,3,4,5};
    1029:	c7 45 ec 03 00 00 00 	movl   $0x3,-0x14(%ebp)
    mprotect((void *)x, 1);
    1030:	50                   	push   %eax
    int a[5] = {1,2,3,4,5};
    1031:	c7 45 f0 04 00 00 00 	movl   $0x4,-0x10(%ebp)
    1038:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
    mprotect((void *)x, 1);
    103f:	e8 1e 03 00 00       	call   1362 <mprotect>
    a[2] = 20;
    1044:	c7 45 ec 14 00 00 00 	movl   $0x14,-0x14(%ebp)


   exit();
    104b:	e8 52 02 00 00       	call   12a2 <exit>
    ...
    1389:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13b7:	f7 f1                	div    %ecx
    13b9:	0f b6 92 a0 17 00 00 	movzbl 0x17a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15fe:	e9 6c fe ff ff       	jmp    146f <printf+0x4f>
          s = "(null)";
    1603:	bb 98 17 00 00       	mov    $0x1798,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 44 1a 00 00       	mov    0x1a44,%eax
{
  ...
  freep = p;
    164f:	a3 44 1a 00 00       	mov    %eax,0x1a44
}
    1654:	5b                   	pop    %ebx
    1655:	5e                   	pop    %esi
    1656:	5f                   	pop    %edi
    ...
    1666:	72 ce                	jb     1636 <free+0x26>
{
  ...
  freep = p;
    168a:	a3 44 1a 00 00       	mov    %eax,0x1a44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ac:	8b 15 44 1a 00 00    	mov    0x1a44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16f1:	39 05 44 1a 00 00    	cmp    %eax,0x1a44
  ...
  return freep;
    171b:	8b 15 44 1a 00 00    	mov    0x1a44,%edx
    ...
    1744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1747:	89 15 44 1a 00 00    	mov    %edx,0x1a44
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 44 1a 00 00 48 	movl   $0x1a48,0x1a44
    1767:	1a 00 00 
    176a:	c7 05 48 1a 00 00 48 	movl   $0x1a48,0x1a48
    1771:	1a 00 00 
    base.s.size = 0;
    1774:	b8 48 1a 00 00       	mov    $0x1a48,%eax
    1779:	c7 05 4c 1a 00 00 00 	movl   $0x0,0x1a4c
    1780:	00 00 00 
