...
int main(int argc, char* argv[]){
    ...
    101f:	e8 15 05 00 00       	call   1539 <settickets>
    int rc = fork();
    1024:	e8 58 04 00 00       	call   1481 <fork>
    if(rc == 0){
    ...
    1034:	50                   	push   %eax
    1035:	50                   	push   %eax
    1036:	68 16 18 00 00       	push   $0x1816
    103b:	6a 01                	push   $0x1
    103d:	e8 ce 05 00 00       	call   1610 <printf>
        exit();
    1042:	e8 42 04 00 00       	call   1489 <exit>
        printf(1,"\nSucsses in forking.\n");
    1047:	52                   	push   %edx
    1048:	52                   	push   %edx
    1049:	68 00 18 00 00       	push   $0x1800
    104e:	6a 01                	push   $0x1
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12d1:	a1 14 1b 00 00       	mov    0x1b14,%eax
{
  ...
  freep = p;
    130f:	a3 14 1b 00 00       	mov    %eax,0x1b14
}
    1314:	5b                   	pop    %ebx
    1315:	5e                   	pop    %esi
    1316:	5f                   	pop    %edi
    ...
    1326:	72 ce                	jb     12f6 <free+0x26>
{
  ...
  freep = p;
    134a:	a3 14 1b 00 00       	mov    %eax,0x1b14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    136c:	8b 15 14 1b 00 00    	mov    0x1b14,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    13b1:	39 05 14 1b 00 00    	cmp    %eax,0x1b14
  ...
  return freep;
    13db:	8b 15 14 1b 00 00    	mov    0x1b14,%edx
    ...
    1404:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1407:	89 15 14 1b 00 00    	mov    %edx,0x1b14
    ...
    base.s.ptr = freep = prevp = &base;
    1420:	c7 05 14 1b 00 00 18 	movl   $0x1b18,0x1b14
    1427:	1b 00 00 
    142a:	c7 05 18 1b 00 00 18 	movl   $0x1b18,0x1b18
    1431:	1b 00 00 
    base.s.size = 0;
    1434:	b8 18 1b 00 00       	mov    $0x1b18,%eax
    1439:	c7 05 1c 1b 00 00 00 	movl   $0x0,0x1b1c
    1440:	00 00 00 
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    17ee:	e9 6c fe ff ff       	jmp    165f <printf+0x4f>
          s = "(null)";
    17f3:	bb 29 18 00 00       	mov    $0x1829,%ebx
        while(*s != 0){
