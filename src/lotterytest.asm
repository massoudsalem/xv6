...
int main(int argc, char* argv[]){
  ...
  17:	e8 24 02 00 00       	call   240 <atoi>
    settickets(tickets_number);
  1c:	89 04 24             	mov    %eax,(%esp)
  1f:	e8 3e 03 00 00       	call   362 <settickets>
    int rc = fork();
  24:	e8 81 02 00 00       	call   2aa <fork>
    if(rc == 0){
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	74 17                	je     47 <main+0x47>
        printf(1,"\nSucsses in forking.\n");
    }else if(rc < 0){
  30:	78 02                	js     34 <main+0x34>
  32:	eb fe                	jmp    32 <main+0x32>
        printf(1,"\nfail in forking.\n");
  34:	50                   	push   %eax
  35:	50                   	push   %eax
  36:	68 ae 07 00 00       	push   $0x7ae
  3b:	6a 01                	push   $0x1
  ...
  47:	52                   	push   %edx
  48:	52                   	push   %edx
  49:	68 98 07 00 00       	push   $0x798
  4e:	6a 01                	push   $0x1
  50:	e8 cb 03 00 00       	call   420 <printf>
  55:	83 c4 10             	add    $0x10,%esp
  58:	eb d8                	jmp    32 <main+0x32>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5fe:	e9 6c fe ff ff       	jmp    46f <printf+0x4f>
          s = "(null)";
 603:	bb c1 07 00 00       	mov    $0x7c1,%ebx
        while(*s != 0){
