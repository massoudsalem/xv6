...
main(int argc, char *argv[])
{
  ...
  p = (int *)100000000;
  printf(1, "%x\n",*p);
  11:	ff 35 00 e1 f5 05    	pushl  0x5f5e100
  17:	68 58 07 00 00       	push   $0x758
  1c:	6a 01                	push   $0x1
  1e:	e8 bd 03 00 00       	call   3e0 <printf>
  exit();
  23:	e8 5a 02 00 00       	call   282 <exit>
  28:	66 90                	xchg   %ax,%ax
  2a:	66 90                	xchg   %ax,%ax
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5be:	e9 6c fe ff ff       	jmp    42f <printf+0x4f>
          s = "(null)";
 5c3:	bb 5c 07 00 00       	mov    $0x75c,%ebx
        while(*s != 0){
