...
_pointer:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  p = (int *)100000000;
  printf(1, "%x\n",*p);
    1011:	ff 35 00 e1 f5 05    	pushl  0x5f5e100
    1017:	68 68 17 00 00       	push   $0x1768
    101c:	6a 01                	push   $0x1
    101e:	e8 cd 03 00 00       	call   13f0 <printf>
  exit();
    1023:	e8 5a 02 00 00       	call   1282 <exit>
    ...
    1359:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1387:	f7 f1                	div    %ecx
    1389:	0f b6 92 74 17 00 00 	movzbl 0x1774(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15ce:	e9 6c fe ff ff       	jmp    143f <printf+0x4f>
          s = "(null)";
    15d3:	bb 6c 17 00 00       	mov    $0x176c,%ebx
        while(*s != 0){
...
000015e0 <free>:
    15e0:	55                   	push   %ebp
    15e1:	a1 18 1a 00 00       	mov    0x1a18,%eax
    ...
    161f:	a3 18 1a 00 00       	mov    %eax,0x1a18
    1624:	5b                   	pop    %ebx
    1625:	5e                   	pop    %esi
    1626:	5f                   	pop    %edi
    1627:	5d                   	pop    %ebp
    ...
    165a:	a3 18 1a 00 00       	mov    %eax,0x1a18
...
00001670 <malloc>:
    ...
    167c:	8b 15 18 1a 00 00    	mov    0x1a18,%edx
    ...
    16c1:	39 05 18 1a 00 00    	cmp    %eax,0x1a18
    ...
    16eb:	8b 15 18 1a 00 00    	mov    0x1a18,%edx
    ...
    1717:	89 15 18 1a 00 00    	mov    %edx,0x1a18
    ...
    1730:	c7 05 18 1a 00 00 1c 	movl   $0x1a1c,0x1a18
    1737:	1a 00 00 
    173a:	c7 05 1c 1a 00 00 1c 	movl   $0x1a1c,0x1a1c
    1741:	1a 00 00 
    1744:	b8 1c 1a 00 00       	mov    $0x1a1c,%eax
    1749:	c7 05 20 1a 00 00 00 	movl   $0x0,0x1a20
    1750:	00 00 00 
