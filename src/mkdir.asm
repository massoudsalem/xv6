...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1053:	68 cf 17 00 00       	push   $0x17cf
    1058:	6a 02                	push   $0x2
    ...
    13a9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13d7:	f7 f1                	div    %ecx
    13d9:	0f b6 92 f4 17 00 00 	movzbl 0x17f4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    161e:	e9 6c fe ff ff       	jmp    148f <printf+0x4f>
          s = "(null)";
    1623:	bb eb 17 00 00       	mov    $0x17eb,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1631:	a1 a4 1a 00 00       	mov    0x1aa4,%eax
{
  ...
  freep = p;
    166f:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
}
    1674:	5b                   	pop    %ebx
    1675:	5e                   	pop    %esi
    1676:	5f                   	pop    %edi
    ...
    1686:	72 ce                	jb     1656 <free+0x26>
{
  ...
  freep = p;
    16aa:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16cc:	8b 15 a4 1a 00 00    	mov    0x1aa4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1711:	39 05 a4 1a 00 00    	cmp    %eax,0x1aa4
  ...
  return freep;
    173b:	8b 15 a4 1a 00 00    	mov    0x1aa4,%edx
    ...
    1764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1767:	89 15 a4 1a 00 00    	mov    %edx,0x1aa4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1780:	c7 05 a4 1a 00 00 a8 	movl   $0x1aa8,0x1aa4
    1787:	1a 00 00 
    178a:	c7 05 a8 1a 00 00 a8 	movl   $0x1aa8,0x1aa8
    1791:	1a 00 00 
    base.s.size = 0;
    1794:	b8 a8 1a 00 00       	mov    $0x1aa8,%eax
    1799:	c7 05 ac 1a 00 00 00 	movl   $0x0,0x1aac
    17a0:	00 00 00 
