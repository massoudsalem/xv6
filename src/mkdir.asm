...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1035:	e8 d7 04 00 00       	call   1511 <mkdir>
  ...
  exit();
    ...
    1053:	68 37 18 00 00       	push   $0x1837
    1058:	6a 02                	push   $0x2
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12f1:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
{
  ...
  freep = p;
    132f:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
}
    1334:	5b                   	pop    %ebx
    1335:	5e                   	pop    %esi
    1336:	5f                   	pop    %edi
    ...
    1346:	72 ce                	jb     1316 <free+0x26>
{
  ...
  freep = p;
    136a:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    138c:	8b 15 4c 1b 00 00    	mov    0x1b4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    13d1:	39 05 4c 1b 00 00    	cmp    %eax,0x1b4c
  ...
  return freep;
    13fb:	8b 15 4c 1b 00 00    	mov    0x1b4c,%edx
    ...
    1424:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1427:	89 15 4c 1b 00 00    	mov    %edx,0x1b4c
    ...
    base.s.ptr = freep = prevp = &base;
    1440:	c7 05 4c 1b 00 00 50 	movl   $0x1b50,0x1b4c
    1447:	1b 00 00 
    144a:	c7 05 50 1b 00 00 50 	movl   $0x1b50,0x1b50
    1451:	1b 00 00 
    base.s.size = 0;
    1454:	b8 50 1b 00 00       	mov    $0x1b50,%eax
    1459:	c7 05 54 1b 00 00 00 	movl   $0x0,0x1b54
    1460:	00 00 00 
    ...
    1599:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    15c7:	f7 f1                	div    %ecx
    15c9:	0f b6 92 5c 18 00 00 	movzbl 0x185c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    180e:	e9 6c fe ff ff       	jmp    167f <printf+0x4f>
          s = "(null)";
    1813:	bb 53 18 00 00       	mov    $0x1853,%ebx
        while(*s != 0){
