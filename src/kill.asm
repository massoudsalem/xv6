...
main(int argc, char **argv)
{
  ...
  exit();
    ...
    1049:	50                   	push   %eax
    104a:	50                   	push   %eax
    104b:	68 98 17 00 00       	push   $0x1798
    1050:	6a 02                	push   $0x2
    ...
    1389:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13b7:	f7 f1                	div    %ecx
    13b9:	0f b6 92 b4 17 00 00 	movzbl 0x17b4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15fe:	e9 6c fe ff ff       	jmp    146f <printf+0x4f>
          s = "(null)";
    1603:	bb ac 17 00 00       	mov    $0x17ac,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 60 1a 00 00       	mov    0x1a60,%eax
{
  ...
  freep = p;
    164f:	a3 60 1a 00 00       	mov    %eax,0x1a60
}
    1654:	5b                   	pop    %ebx
    1655:	5e                   	pop    %esi
    1656:	5f                   	pop    %edi
    ...
    1666:	72 ce                	jb     1636 <free+0x26>
{
  ...
  freep = p;
    168a:	a3 60 1a 00 00       	mov    %eax,0x1a60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ac:	8b 15 60 1a 00 00    	mov    0x1a60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16f1:	39 05 60 1a 00 00    	cmp    %eax,0x1a60
  ...
  return freep;
    171b:	8b 15 60 1a 00 00    	mov    0x1a60,%edx
    ...
    1744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1747:	89 15 60 1a 00 00    	mov    %edx,0x1a60
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 60 1a 00 00 64 	movl   $0x1a64,0x1a60
    1767:	1a 00 00 
    176a:	c7 05 64 1a 00 00 64 	movl   $0x1a64,0x1a64
    1771:	1a 00 00 
    base.s.size = 0;
    1774:	b8 64 1a 00 00       	mov    $0x1a64,%eax
    1779:	c7 05 68 1a 00 00 00 	movl   $0x0,0x1a68
    1780:	00 00 00 
