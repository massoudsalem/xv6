    ...
    1007:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 98 17 00 00       	push   $0x1798
    101e:	6a 02                	push   $0x2
  ...
  exit();
    ...
    1049:	68 ab 17 00 00       	push   $0x17ab
    104e:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15fe:	e9 6c fe ff ff       	jmp    146f <printf+0x4f>
          s = "(null)";
    1603:	bb bf 17 00 00       	mov    $0x17bf,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 70 1a 00 00       	mov    0x1a70,%eax
{
  ...
  freep = p;
    164f:	a3 70 1a 00 00       	mov    %eax,0x1a70
}
    1654:	5b                   	pop    %ebx
    1655:	5e                   	pop    %esi
    1656:	5f                   	pop    %edi
    ...
    1666:	72 ce                	jb     1636 <free+0x26>
{
  ...
  freep = p;
    168a:	a3 70 1a 00 00       	mov    %eax,0x1a70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ac:	8b 15 70 1a 00 00    	mov    0x1a70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16f1:	39 05 70 1a 00 00    	cmp    %eax,0x1a70
  ...
  return freep;
    171b:	8b 15 70 1a 00 00    	mov    0x1a70,%edx
    ...
    1744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1747:	89 15 70 1a 00 00    	mov    %edx,0x1a70
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 70 1a 00 00 74 	movl   $0x1a74,0x1a70
    1767:	1a 00 00 
    176a:	c7 05 74 1a 00 00 74 	movl   $0x1a74,0x1a74
    1771:	1a 00 00 
    base.s.size = 0;
    1774:	b8 74 1a 00 00       	mov    $0x1a74,%eax
    1779:	c7 05 78 1a 00 00 00 	movl   $0x0,0x1a78
    1780:	00 00 00 
