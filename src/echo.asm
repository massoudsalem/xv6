...
printf(int fd, const char *fmt, ...)
{
 ...
 474:	e8 69 fe ff ff       	call   2e2 <write>
 ...
 4dd:	e8 00 fe ff ff       	call   2e2 <write>
 ...
 4f4:	e8 e9 fd ff ff       	call   2e2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5ce:	50                   	push   %eax
 5cf:	53                   	push   %ebx
 5d0:	e8 0d fd ff ff       	call   2e2 <write>
        while(*s != 0){
